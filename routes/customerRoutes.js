...
const { deleteCustomerTable, createNewCustomer, updateCustomerDetails, deleteCustomer, getCustomerLists, getCustomerTotalCount } = require('../controllers/customerController');
